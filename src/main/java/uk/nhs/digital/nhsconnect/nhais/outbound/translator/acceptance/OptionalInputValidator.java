...
public class OptionalInputValidator {
    ...
    public boolean surnameIsMissing(Parameters parameters) {
        return StringUtils.isBlank(ParametersExtension.extractPatient(parameters).getNameFirstRep().getFamily());
    }
}
