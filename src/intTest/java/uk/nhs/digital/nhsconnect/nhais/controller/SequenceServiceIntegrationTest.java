...
public class SequenceServiceIntegrationTest {
    ...
    private final static String TRANSACTION_KEY = "transaction_id-sender";
    ...
    public void When_GenerateTransactionId_Then_IncreasedByOne() {
        ...
        assertThat(sequenceService.generateTransactionId(TRANSACTION_KEY)).isEqualTo(1L);
        assertThat(sequenceService.generateTransactionId(TRANSACTION_KEY)).isEqualTo(2L);
        assertThat(sequenceService.generateTransactionId(TRANSACTION_KEY)).isEqualTo(3L);
    }
    ...
    private List<Long> generateMultiThreadedSeqList() {
        ...
        for (int i = 0; i < 100; i++) {
            service.submit(() -> {
                seqList.add(sequenceService.generateTransactionId(TRANSACTION_KEY));
            });
        }
