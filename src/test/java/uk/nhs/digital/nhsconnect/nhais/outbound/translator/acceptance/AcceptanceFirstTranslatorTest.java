...
class AcceptanceFirstTranslatorTest {

    @Mock private OptionalInputValidator validator;

    @InjectMocks
    private AcceptanceFirstTranslator acceptanceFirstTranslator;
    ...
    void When_MissingNhsNumberAndBirthPlace_Then_ThrowFhirValidationException() {
        ...
        assertThatThrownBy(() -> acceptanceFirstTranslator.translate(parameters))
