...
Documents in the `outboundState` (**TODO**: inboundState) collection also contain the conversation id.

Messages published to the adaptor's three (**TODO**: inbound queues) AMQP message queues include a ConversationId header.
