...
export NHAIS_MESH_POLLING_CYCLE_MINIMUM_INTERVAL_IN_SECONDS=5 # default: 300 (5 minutes)
export NHAIS_MESH_CLIENT_WAKEUP_INTERVAL_IN_MILLISECONDS=2500 # default: 60000 (1 minute)
export NHAIS_MESH_CERT_VALIDATION=false

export NHAIS_MESH_MAILBOX_PASSWORD=password
export NHAIS_MESH_SHARED_KEY=SharedKey
export NHAIS_MESH_HOST=https://fake-mesh:8829/messageexchange/
export NHAIS_MESH_ENDPOINT_CERT="-----BEGIN CERTIFICATE-----
...
-----END CERTIFICATE-----"
export NHAIS_MESH_ENDPOINT_PRIVATE_KEY="-----BEGIN RSA PRIVATE KEY-----
