...
to that NHAIS instance's MESH Mailbox Id in the NHAIS_MESH_CYPHER_TO_MAILBOX environment variable. A "Destination HA 
Cipher" can usually be converted into a "HA Link Code" by appending 0 or 01 to create the four-character code. If in 
doubt consult with the operator of the NHAIS instance for the correct value.
