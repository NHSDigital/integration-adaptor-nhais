...
| NHAIS_GP_SYSTEM_INBOUND_QUEUE_NAME | nhais_gp_system_inbound | Queue name used to publish [Health Authority to GP System messages](./INBOUND.md) which should be consumed by the GP system                                    |
